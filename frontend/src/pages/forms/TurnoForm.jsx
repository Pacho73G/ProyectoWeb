...
export function TurnoForm({ turno, onSave, onCancel }) {
  const fields = [
    ...
    {name: 'fecha', label: 'Fecha', type: 'date', required: true, min: (() => { const d = new Date(); return `${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,'0')}-${String(d.getDate()).padStart(2,'0')}`; })()},
